...
asv[,3:87] <- t(t(asv[,-c(1:2)])/colSums(asv[,-c(1:2)]))
...
pred_df <- pred_df %>% subset(transect=="GA02")
...
setwd("C:/Users/jlwei/Documents/bhet_code/Figures")
pdf("Copiotrophy_ridges_GA02.pdf",width=10,height=10)
pCr
dev.off()
...
setwd("C:/Users/jlwei/Documents/bhet_code/Data")
write.table(asv_CI,file="Copiotrophy_index_GA02.tsv")
write.csv(asv_CI,file="Copiotrophy_index_GA02.csv")
